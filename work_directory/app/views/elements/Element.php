...
require_once __DIR__.'/../../../../src/library/LocaleFunctions.php';
...
abstract class Element
{
     ...
     */
    public function renderNavbar($logged_in)
    { ?>
        <div class='noscript-hide'><?php
            if ($logged_in) {
            ...
            if (!$logged_in) { ?>
                <div class="buttons">
                    <a class="btn-signup" href='<?= B\controllerUrl('register') ?>?a=createAccount'>Sign Up</a>
                    <a class="btn-signin" href='<?= B\controllerUrl('admin') ?>'>LOG IN</a>
                </div><?php
            } ?>
        </div>
        <?php
